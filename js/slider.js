...
const showSlide = e => {
    ...
    var element = document.getElementById('sliderImages');
    const images = element.getElementsByTagName('img');
    const indicators = element.querySelectorAll('.slider-indicators span');
    const contents = element.querySelectorAll('.slider-content h3');
